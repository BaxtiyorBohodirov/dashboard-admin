...
<script>
    $("#malumotlardate").mask("9999-99-99",{placeholder:"YYYY-MM-DD"});
    $("#isgazoilastirisdate").mask("9999-99-99",{placeholder:"YYYY-MM-DD"});
    $("#kasbgaqitisdate").mask("9999-99-99",{placeholder:"YYYY-MM-DD"});
</script>
@endsection
